...
def main():
    ...
    if sys.prefix==sys.base_prefix:
        print('Use INSTALAR.bat or instalar.sh: dependencies are installed in .venv.');return 1
    ...
    wheels=ROOT/'wheels_windows'
    if os.name=='nt' and wheels.exists():command.extend(['--no-index','--find-links',str(wheels)])
    print('Installing SHA-256-verified dependencies. No keys are requested during this step.')
