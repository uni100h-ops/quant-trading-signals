...
PUBLISHER_POLICY = {"service_url":"","builder_address":"","algorand_recipient":"","builder_fee_bps":"10","service_price_usdc":"0.01","fee_payer_mainnet":"","fee_payer_testnet":""}
...
class AuditService:
    ...
    def __init__(self,cfg,facilitator=None,algod=None,market=None,now=None):
        ...
        folder=cfg.root/'estado_servidor';folder.mkdir(exist_ok=True)
...
class SignalFeed:
    ...
    def __init__(self,cfg,api=None,now=None,min_gap_ms=15_000,strategy=None):
        ...
        folder=cfg.root/'estado_servidor';folder.mkdir(exist_ok=True)
        self.store=Store(folder/'senal.sqlite3')
    ...
    def decision(self,signal_ms):
        ...
        with self.lock:
            if self.now()-self.fetched>=self.min_gap or signal_ms not in self.table:
